...
exports.getAllDistricts = (req, res)=>{
    x(
        ...
        districts: x('tr', [{
            ...
            // },
            recovered:{
                total:'td:nth-child(3) span.text-success | whiteSpaces', 
                new: 'td:nth-child(3) sub.text-success | whiteSpaces'
            },
            quarantined:'td:nth-child(4) span.text-blue | whiteSpaces', 
            deaths:{
                total:'td:nth-child(5) span | whiteSpaces',
                new:'td:nth-child(5) sub'
            }
        }])
    }
